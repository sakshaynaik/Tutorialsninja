...
public class ReadAction {
	...
	public static void scrollByVisibilityOfElementByJS(WebDriver driver, WebElement ele) {
	...
	public static void mouveToElementByActions(WebDriver driver, WebElement element) {
		boolean flag = false;
		try {
	...
	public static boolean moveToElementByJS(WebDriver driver, WebElement ele) {
		boolean flag = false;
		try {
			// WebElement element = driver.findElement(locator);
			JavascriptExecutor executor = (JavascriptExecutor) driver;
	...
	public static boolean sliderByActions(WebDriver driver, WebElement ele, int x, int y) {
		boolean flag = false;
		try {
	...
	public static boolean alertSendKeys(WebDriver driver, String txt) {
	...
	public static String getText(WebDriver driver, WebElement element) {
		...
		if (!flag) {
			System.out.println("Text of the Webelement is: \"" + text + "\"");
		}
		return text;
	}
	...
	public static String screenShot(WebDriver driver, String filename) {
		...
		String newImageString = "http://localhost:8082/job/MyStoreProject/ws/opencartProject/ScreenShots/" + filename
				+ "_" + dateName + ".png";
